...
-- ── Usuarios ──────────────────────────────────────────────────────────────────
-- id 1 → admin Bilbao  (administrador)
-- id 2 → Alexander     (administrador)
-- id 3 → María         (editor) — artículo en revisión pendiente
-- id 4 → Carlos        (editor) — artículo rechazado con feedback
...
('María González',        'maria.gonzalez@bilbao.edu.mx',    '$2y$12$LNYINILdgb8ohkVKW343UeGCoOsnp/sb7dqGIwubF3aDjBiMwm/C2',  'editor'),
('Carlos Ramírez',        'carlos.ramirez@bilbao.edu.mx',    '$2y$12$LNYINILdgb8ohkVKW343UeGCoOsnp/sb7dqGIwubF3aDjBiMwm/C2',  'editor');
...
--   estado, envio_revision, comentario_revision,
--   fecha_publicacion, tiempo_lectura,
--   vistas, likes, categoria_id, autor_id
--
--  Distribución de ejemplo:
--   arts 1-10  → publicado, sin revisión pendiente, con vistas y likes orgánicos
--   art 11     → borrador de editor (María, id=3), envio_revision=1 (esperando aprobación)
--   art 12     → borrador de editor (Carlos, id=4), comentario_revision con feedback del admin
...
-- 1. Publicado · sin revisión · autor admin
(
  ...
  'publicado', 0, NULL,
  '2026-05-01 09:00:00', 4,
  842, 37, 1, 2
),

-- 2. Publicado · sin revisión
(
...
(
  ...
  'publicado', 0, NULL,
  '2026-03-24 10:00:00', 5,
  176, 9, 3, 2
),

-- 11. Borrador de editor María · envio_revision=1 → aparece en /dashboard/revisiones
(
  'El juego como estrategia pedagógica en preescolar',
  'juego-estrategia-pedagogica-preescolar',
  'En los primeros años de vida, jugar no es la alternativa al aprendizaje. Es el aprendizaje mismo.',
  '<p>La neurociencia lleva décadas confirmando lo que los maestros de preescolar ya sabían por intuición: los niños aprenden mejor cuando juegan. No porque el juego sea un descanso del esfuerzo cognitivo, sino porque es su forma natural de ejercerlo.</p><p>En el juego libre, un niño de cuatro años toma decisiones, negocia reglas, gestiona frustraciones y construye hipótesis sobre el mundo físico. Todo eso requiere exactamente las mismas capacidades que usará décadas después en una reunión de trabajo o en un proyecto de investigación.</p><h2>Juego estructurado vs. juego libre</h2><p>El debate pedagógico distingue entre el juego libre, donde el niño dirige la actividad, y el juego estructurado, diseñado por el docente con un objetivo específico. Ambos son valiosos y complementarios: el primero desarrolla autonomía; el segundo, habilidades concretas.</p>',
  'borrador', 1, NULL,
  NULL, 5,
  0, 0, 4, 3
),

-- 12. Borrador de editor Carlos · rechazado con feedback del admin (comentario_revision)
(
  'Tecnología en el aula: ¿aliada o distracción?',
  'tecnologia-en-el-aula-aliada-o-distraccion',
  'El debate sobre el uso del celular y la tablet en clases no tiene una respuesta única. Depende de cómo se usa, no de si se usa.',
  '<p>Hay escuelas que prohíben completamente los teléfonos. Hay otras que los integran como herramienta central. Ninguna de las dos posiciones extremas resiste un análisis serio.</p><p>La tecnología en el aula es neutra como objeto. Lo que determina si suma o resta aprendizaje es la intención pedagógica detrás de su uso. Un alumno que busca en Google durante una clase puede estar profundizando un tema o evitando pensar. La diferencia la hace el diseño de la actividad.</p>',
  'borrador', 0, 'El artículo tiene buena base pero necesita más desarrollo. Agrega al menos dos fuentes académicas y amplía la sección de ejemplos concretos con casos del propio colegio. El tono de la conclusión es demasiado ambiguo; toma una postura clara. Puedes reenviar para revisión cuando lo tengas listo.',
  NULL, 3,
  0, 0, 6, 4
);
...
-- ── Noticias ──────────────────────────────────────────────────────────────────
--  Columnas:
--   titulo, slug, extracto, contenido, portada, portada_alt,
--   estado, envio_revision, comentario_revision,
--   destacada, fecha_publicacion, tiempo_lectura,
--   vistas, likes, categoria_id, autor_id
--
--  Distribución de ejemplo:
--   nots 1-10  → publicadas, sin revisión, con vistas y likes
--   not 11     → borrador de editor (María, id=3), envio_revision=1 (esperando aprobación)
--   not 12     → borrador de editor (Carlos, id=4), comentario_revision con feedback
...
-- 1. Destacada · publicada · alta tracción
(
...
(
  ...
  NULL, NULL,
  'publicado', 0, NULL,
  0, '2026-04-01 10:00:00', 4,
  362, 18, 1, 2
),

-- 11. Borrador de editor María · envio_revision=1 → aparece en /dashboard/revisiones
(
  'Taller de escritura creativa: alumnos publican su primera antología',
  'taller-escritura-creativa-antologia',
  'El taller optativo de escritura de preparatoria culminó con la publicación de una antología de cuentos cortos escritos íntegramente por los alumnos.',
  '<p>El taller de escritura creativa del Colegio Bilbao cerró el ciclo con un hito: la publicación de <em>Voces propias</em>, una antología de cuentos cortos escritos por los dieciocho alumnos del taller de preparatoria.</p><p>El proceso duró seis meses e incluyó talleres de técnica narrativa, sesiones de retroalimentación entre pares y una ronda de edición profesional a cargo de una escritora invitada. El resultado es un libro de 140 páginas disponible en la biblioteca del colegio.</p>',
  NULL, NULL,
  'borrador', 1, NULL,
  0, NULL, 4,
  0, 0, 3, 3
...
-- 12. Borrador de editor Carlos · rechazado con feedback
(
  'Nuevas becas para familias de bajos ingresos: convocatoria abierta',
  'becas-familias-bajos-ingresos-convocatoria',
  'El Colegio Bilbao abre su convocatoria anual de becas para el ciclo 2026-2027, con tres modalidades y un proceso de selección completamente renovado.',
  '<p>El programa de becas del Colegio Bilbao abre su convocatoria para el ciclo escolar 2026-2027. Este año se ofrecen tres modalidades: beca de excelencia académica, beca socioeconómica y beca de talento artístico o deportivo.</p><p>Las familias interesadas pueden iniciar su solicitud en línea a partir del 1 de junio. El proceso de selección incluye revisión de documentos, entrevista con el área de orientación y análisis de expediente académico.</p>',
  NULL, NULL,
  'borrador', 0, 'Buen tema y relevante, pero faltan datos clave: ¿cuántas becas se otorgarán por modalidad? ¿Cuáles son los requisitos mínimos de promedio? ¿Cuál es la fecha límite de solicitud? Sin esa información la nota no sirve a las familias. Coordina con Dirección para obtener los datos y reenvía.',
  0, NULL, 3,
  0, 0, 5, 4
);

-- Resetear vistas a cero
UPDATE articulos SET vistas = 0;
UPDATE noticias  SET vistas = 0;
