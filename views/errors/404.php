    ...
    <div class="error-404-inner">
        ...
        <div class="error-text-col">
            ...
            <h1 class="error-headline">
                Esta página<br><span>no existe</span>
            </h1>
            ...
            <div class="error-actions">
                <a href="/" class="btn-primario">Ir al inicio</a>
                <a href="javascript:history.back()" class="btn-secundario">← Volver atrás</a>
            </div>

            <div class="error-divider"></div>

            <p class="error-explore-label">Explora el sitio</p>
