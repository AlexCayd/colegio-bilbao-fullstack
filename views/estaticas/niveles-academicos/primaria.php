<main id="main-content" class="page-main page-primaria">
        ...
        <section id="cuestiona" class="section-container">
            <div class="organic-block">
                ...
                <div class="organic-img-wrapper">
                    <img src="/build/assets/img/niveles-academicos/primaria/clase-sexto.jpg" alt="Clase de sexto grado">
                </div>
            </div>
        </section>
        ...
        <section id="persona" class="section-container">
             <div class="organic-block"> <!-- Orden normal: Texto Izq, Imagen Der -->
                ...
                <div class="organic-img-wrapper img-vertical">
                    <img src="/build/assets/img/niveles-academicos/primaria/alumna-feliz.jpg" alt="Alumna feliz en clase">
                </div>
            </div>
        </section>
        ...
        <section id="proyectos" class="learning-section">
            <div class="organic-block">
                <div class="organic-img-wrapper">
                     <img src="/build/assets/img/niveles-academicos/primaria/alumna-escribiendo.jpg" alt="Alumna tomando notas">
                </div>
                <div class="organic-text">
            ...
            <div class="transition-wrapper">
                ...
                <div class="organic-block">
                     <div class="organic-img-wrapper" style="height: 300px;">
                        <img src="/build/assets/img/niveles-academicos/primaria/alumnas-abrazadas.jpg" alt="Amigas felices">
                    </div>
                    <div class="organic-text">
        ...
        <section class="cta-section">
            <div class="cta-container">
                ...
                <div class="cta-content">
                    ...
                    <a href="https://wa.me/525614612682?text=Hola,%20acabo%20de%20ver%20la%20página%20de%20primaria,%20me%20gustó%20y%20quiero%20conocer%20el%20colegio%20en%20una%20visita%20guiada." target="_blank" class="btn-primario">
