...
<head>
    ...
    <meta name="description" content="Colegio Bilbao: Estamos trabajando en esta sección para brindarte una mejor experiencia.">
    <meta name="robots" content="noindex, follow"> <!-- IMPORTANTE: noindex -->
    
    <title>Colegio Bilbao | Próximamente</title>
    ...
    <style>
        /* --- 1. VARIABLES & RESET (Idéntico a index.html) --- */
        :root {
            --bg-global: #F9FBFE;
            --col-bilbao: #4D8ABB;
            --col-espiritu: #7DC6E5;
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .menu-overlay {
            ...
            background-color: var(--bg-global); z-index: 2000;
        ...
        /* --- CONTENIDO ESPECÍFICO: EN CONSTRUCCIÓN --- */
        main {
            flex-grow: 1; 
        ...
        /* Estilos para la imagen de construcción */
        .construction-image {
            max-width: 100%;
            height: auto;
            max-height: 400px; 
...
<body>
    ...
    <header class="header-bar">
        <div class="header-inner">
            ...
            <div class="header-controls">
                <div class="lang-switch"><span class="active">ES</span> | <a href="/en/" aria-label="Switch to English">EN</a></div>
        ...
        <nav class="overlay-content">
            <ul id="primary-nav">
                ...
                <li class="nav-accordion-item">
                    <button class="nav-accordion-trigger" aria-expanded="false" aria-controls="submenu-conocenos">
                        Conócenos <span class="chevron" aria-hidden="true">▼</span>
                    </button>
                    <ul id="submenu-conocenos" class="nav-submenu">
                ...
                <!-- Nivel 1: Modelo educativo -->
                <li class="nav-accordion-item">
                    <button class="nav-accordion-trigger" aria-expanded="false" aria-controls="submenu-modelo">
                        Modelo educativo <span class="chevron" aria-hidden="true">▼</span>
                    </button>
                    <ul id="submenu-modelo" class="nav-submenu">
                        <li><a href="/modelo-educativo/modelo-vida/">Modelo VIDA</a></li>
                        <li><a href="/modelo-educativo/filosofia-y-metodologia/">Filosofía y metodología</a></li>
                        <li><a href="/modelo-educativo/aprendizaje-integral/">Aprendizaje integral</a></li>
                        <li><a href="/modelo-educativo/idiomas/">Idiomas</a></li>
                    </ul>
                </li>
                <!-- Nivel 1: Niveles académicos -->
                <li class="nav-accordion-item">
                    <button class="nav-accordion-trigger" aria-expanded="false" aria-controls="submenu-niveles">
                        Niveles académicos <span class="chevron" aria-hidden="true">▼</span>
                    </button>
                    <ul id="submenu-niveles" class="nav-submenu">
                ...
                <!-- Nivel 1: Vida escolar -->
                <li class="nav-accordion-item">
                    <button class="nav-accordion-trigger" aria-expanded="false" aria-controls="submenu-vida">
                        Vida escolar <span class="chevron" aria-hidden="true">▼</span>
                    </button>
                    <ul id="submenu-vida" class="nav-submenu">
                        <li><a href="/vida-escolar/afterschool-extracurriculares/">Afterschool & Extracurriculares</a></li>
                        ...
                        <li><a href="/vida-escolar/servicios-para-familias/">Servicios para familias</a></li>
                        <li><a href="/vida-escolar/cuidado-y-bienestar/">Cuidado y bienestar</a></li>
                        <li><a href="/vida-escolar/eventos-y-tradiciones/">Eventos y tradiciones</a></li>
                    </ul>
                </li>
                <!-- Nivel 1: Admisiones -->
                <li class="nav-accordion-item">
                    <button class="nav-accordion-trigger" aria-expanded="false" aria-controls="submenu-admisiones">
                        Admisiones <span class="chevron" aria-hidden="true">▼</span>
                    </button>
                    <ul id="submenu-admisiones" class="nav-submenu">
                        <li><a href="/admisiones/">Inicio Admisiones</a></li>
                        <li><a href="/admisiones/proceso/">Proceso de admisión</a></li>
                        <li><a href="/admisiones/preguntas-frecuentes/">Preguntas frecuentes</a></li>
                        <li><a href="/admisiones/convenios/">Convenios</a></li>
                        <li><a href="/admisiones/convocatoria-becas/">Convocatoria becas</a></li>
                        <li><a href="/admisiones/contacto/">Contacto de admisión</a></li>
                    </ul>
                </li>
                <!-- Nivel 1: Comunidad -->
                <li class="nav-accordion-item">
                    <button class="nav-accordion-trigger" aria-expanded="false" aria-controls="submenu-comunidad">
                        Comunidad <span class="chevron" aria-hidden="true">▼</span>
                    </button>
                    <ul id="submenu-comunidad" class="nav-submenu">
                ...
                <!-- Nivel 1: Voces Bilbao -->
                <li class="nav-accordion-item">
                    <button class="nav-accordion-trigger" aria-expanded="false" aria-controls="submenu-voces">
                        Voces Bilbao <span class="chevron" aria-hidden="true">▼</span>
                    </button>
                    <ul id="submenu-voces" class="nav-submenu">
                ...
                <!-- Nivel 1: Contacto -->
                <li class="nav-accordion-item">
                    <button class="nav-accordion-trigger" aria-expanded="false" aria-controls="submenu-contacto">
                        Contacto <span class="chevron" aria-hidden="true">▼</span>
                    </button>
                    <ul id="submenu-contacto" class="nav-submenu">
    ...
    <!-- MAIN CONTENT: CONSTRUCCIÓN -->
    <main id="main-content">
        <div class="construction-container">
            <!-- RUTA DE IMAGEN ACTUALIZADA -->
            <!-- Asegúrate de que el archivo esté en assets/img/global/ -->
            <img src="/assets/img/global/estudiantes-cartel-proximamente.jpg" 
                 alt="Alumnos de Colegio Bilbao trabajando en clase" 
                 class="construction-image"
                 width="600" height="400">
            
            <h1>Próximamente</h1>
            <p class="lead">Estamos construyendo algo extraordinario. Esta sección estará disponible muy pronto con toda la información que buscas.</p>
            
            <a href="/" class="btn-primary">Volver al Inicio</a>
        </div>
    </main>

    <!-- FOOTER COMPLETO (Idéntico a index.html) -->
    <footer>
        <div class="footer-container">
            
            <!-- HEADER DEL FOOTER (Logo Izq + Socials Der) -->
            <div class="footer-header">
                ...
                <!-- Socials Derecha (Visible en Desktop) -->
                <div class="footer-social-desktop">
                    ...
                    <span style="font-weight:700">ES</span> | <a href="/en/">EN</a>
                </div>
            </div>
            ...
            <div class="footer-grid">
                ...
                <!-- Col 1: Identidad (Texto + Contacto) -->
                <div class="footer-identity">
                    ...
                    <div class="footer-contact">
                        ...
                        Cuajimalpa de Morelos, 05600 Ciudad de México, CDMX</p>
                ...
                <div class="footer-col">
                    <button class="footer-col-title" aria-expanded="false">
                        Conócenos <span class="chevron" aria-hidden="true">▼</span>
                    </button>
                ...
                <div class="footer-col">
                    <button class="footer-col-title" aria-expanded="false">
                        Niveles <span class="chevron" aria-hidden="true">▼</span>
                    </button>
                    <ul class="footer-links">
                        <li><a href="/niveles-academicos/preescolar/">Preescolar</a></li>
                        <li><a href="/niveles-academicos/primaria/">Primaria</a></li>
            ...
            <div class="footer-legal">
                ...
                <div>
                    © 2025 Colegio Bilbao. Todos los derechos reservados.
                </div>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        function openMenu() {
            ...
            closeMenuBtn.focus(); // Focus trap start
        }
        ...
        function closeMenu() {
            ...
            menuTrigger.focus(); // Restore focus
        }
        ...
        // Acordeones del Menú Principal
        navAccordions.forEach(trigger => {
            trigger.addEventListener('click', () => {
                // Verificar si hay submenu (si es null, es un enlace directo como Contacto)
        ...
        // --- 2. FOOTER ACCORDION LOGIC (Mobile Only) ---
        const footerToggles = document.querySelectorAll('.footer-col-title');

        footerToggles.forEach(toggle => {
            toggle.addEventListener('click', () => {
                // Verificar si estamos en mobile (check visual style o width)
        ...
        // Asegurar que al redimensionar a desktop, se vean los links
