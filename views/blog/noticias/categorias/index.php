<?php $paginaVista = 'blog-noticias-categorias-index'; ?>
        ...
        <main class="admin-content">
            <div class="admin-panel">
                ...
                <div class="admin-empty-state">
                    <img src="/build/assets/img/alex/alex-tech.png" alt="Alex" class="admin-empty-state__img">
                    <p class="admin-empty-state__text">Aún no hay categorías de noticias.</p>
                    <a href="/dashboard/noticias/categorias/crear" class="admin-btn admin-btn--primary">
                            ...
                            <tr>
                                <td>
                                    <div style="display:flex;align-items:center;gap:10px;">
                                        <span style="width:12px;height:12px;border-radius:3px;background:<?= s($c->color ?? '#374C69') ?>;flex-shrink:0;display:inline-block;"></span>
                                        <div>
                                ...
                                <td style="font-weight:700;color:var(--col-herencia);"><?= (int)$c->total_noticias ?></td>
                                <td>
                                    <div class="admin-table__actions">
                                        <a href="/dashboard/noticias/categorias/editar?id=<?= (int)$c->id ?>" class="admin-table__btn">
...
<div id="deleteModal" class="ubm-backdrop" aria-modal="true" role="dialog" aria-labelledby="ubm-title">
    <div class="ubm-card">
        <div class="ubm-icon"><i class="fa-solid fa-folder-tree"></i></div>
        <h2 class="ubm-title" id="ubm-title">¿Eliminar categoría?</h2>
        <p class="ubm-text">Estás a punto de eliminar <strong id="ubm-name"></strong>. Las noticias asociadas quedarán sin clasificar.</p>
        <div class="ubm-field">
        ...
        <form method="POST" action="/dashboard/noticias/categorias/eliminar" id="ubm-form">
...
if (isset($_GET['success'])) {
    $atConfig = ['title' => '¡Categoría creada!',   'msg' => 'La nueva categoría ya está disponible.', 'icon' => 'fa-folder-tree', 'color' => '#1a8a96', 'bar' => '#1a8a96'];
} elseif (isset($_GET['edited'])) {
    $atConfig = ['title' => '¡Cambios guardados!',  'msg' => 'La categoría fue actualizada.',           'icon' => 'fa-floppy-disk',  'color' => '#319795', 'bar' => '#319795'];
} elseif (isset($_GET['deleted'])) {
    $atConfig = ['title' => '¡Categoría eliminada!','msg' => 'La categoría fue removida.',              'icon' => 'fa-circle-check', 'color' => '#38a169', 'bar' => '#38a169'];
}
?>
<?php if ($atConfig): ?>
<div id="alexToast" class="at-wrap" role="alert" aria-live="polite">
    <span class="at-stripe" style="background:<?= $atConfig['bar'] ?>;"></span>
    <img src="/build/assets/img/alex/alex-tech.png" alt="Alex" class="at-alex">
    <div class="at-body">
