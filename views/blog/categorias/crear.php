<?php $paginaVista = 'blog-categorias-crear'; ?>
<?php
    ...
    <div class="admin-main">
        ...
        <header class="admin-topbar">
            <div class="admin-topbar__left">
                ...
                <span class="admin-topbar__title">Nueva categoría</span>
            </div>
        ...
        <main class="admin-content">
            ...
            <form id="form-categoria" action="/dashboard/categorias/crear" method="POST" novalidate>
                ...
                <div class="admin-form-grid">
                    ...
                    <div>
                        ...
                        <div class="admin-panel" style="margin-bottom:20px;">
                            ...
                            <div class="admin-form-section">
                                ...
                                <div class="admin-form__group">
                                    ...
                                    <span class="admin-form__hint">Máximo 60 caracteres. Elige un nombre claro y descriptivo.</span>
                                </div>
                                ...
                                <div class="admin-form__group">
                                    ...
                                    <span class="admin-form__hint">Se genera automáticamente. Solo letras minúsculas, números y guiones.</span>
                                </div>
                                ...
                                <div class="admin-form__group">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Describe brevemente qué tipo de contenido agrupa esta categoría..."
                                        maxlength="240"
                        ...
                        <div class="admin-panel">
                            ...
                            <div class="admin-form-section">
                                <p style="font-size:0.88rem;color:var(--text-gray);line-height:1.65;margin-bottom:20px;">
                                    El color se usará en las etiquetas del blog para identificar visualmente esta categoría.
                                </p>

                                <div class="admin-form__group">
                                    <label class="admin-form__label">
                                        <i class="fa-solid fa-palette"></i> Elige un color
                                    </label>
                                ...
                                <div style="margin-top:24px;">
                                    ...
                                    <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
                                        ...
                                        <span style="font-size:0.82rem;color:var(--text-gray);">Así se verá la etiqueta en el blog</span>
                                    </div>
                                </div>
                    ...
                    <div>
                        ...
                        <div class="admin-helper-card">
                            ...
                            <h3 class="admin-helper-card__title">¡Organiza el contenido!</h3>
                            <p class="admin-helper-card__text">
                                Las categorías ayudan a los lectores a encontrar rápidamente el contenido que les interesa.
                            </p>
                            <div class="admin-tips">
                                <div class="admin-tip">
                                    <i class="fa-solid fa-tag"></i>
                                    <span>Usa nombres cortos y fáciles de entender para el lector.</span>
                                </div>
                                <div class="admin-tip">
                                    <i class="fa-solid fa-link"></i>
                                    <span>El slug define la URL: <em>/voces-bilbao/slug</em></span>
                                </div>
                                <div class="admin-tip">
                                    <i class="fa-solid fa-palette"></i>
                                    <span>El color diferencia visualmente cada categoría en el blog.</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="admin-panel">
                            <div class="admin-panel__header">
                                ...
                                <a href="/dashboard/categorias" class="admin-panel__action">Ver todas →</a>
                            </div>
                            <div style="padding:16px 24px;display:flex;flex-direction:column;gap:10px;">
                                ...
                                <div style="display:flex;align-items:center;justify-content:space-between;font-size:0.88rem;">
                                    <span style="display:flex;align-items:center;gap:8px;">
                                        <span style="width:10px;height:10px;border-radius:3px;background:<?= s($c->color ?? '#4D8ABB') ?>;display:inline-block;"></span>
                                        <span style="font-weight:600;color:var(--col-herencia);"><?= s($c->nombre) ?></span>
                                    </span>
                                    <span class="admin-badge admin-badge--published" style="font-size:0.7rem;"><?= (int)$c->total_articulos ?> arts.</span>
                                </div>
                                <?php endforeach; ?>
                                <?php endif; ?>
                            </div>
