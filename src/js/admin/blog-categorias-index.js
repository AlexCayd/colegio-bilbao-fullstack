/* blog-categorias-index
   Migrado desde el <script> embebido de views/blog/categorias/index.php */
(function () {
    if (!document.body || document.body.dataset.page !== 'blog-categorias-index') return;
    (function () {
        let _ubmName = '';
