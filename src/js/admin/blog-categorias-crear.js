/* blog-categorias-crear
   Migrado desde el <script> embebido de views/blog/categorias/crear.php */
(function () {
    if (!document.body || document.body.dataset.page !== 'blog-categorias-crear') return;
    (function () {
        function toSlug(str) {
        ...
        // Inicializar desc-count con el valor actual
        if (descEl && descCount) {
