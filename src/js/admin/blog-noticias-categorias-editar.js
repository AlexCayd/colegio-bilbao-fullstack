/* blog-noticias-categorias-editar
   Migrado desde el <script> embebido de views/blog/noticias/categorias/editar.php */
(function () {
    if (!document.body || document.body.dataset.page !== 'blog-noticias-categorias-editar') return;
    (function () {
        function toSlug(str) {
